 ...
 *
 * "Do you already have a list?" is asked after step 1, at the list-choice
 * page. `"yes"` is the default; `"no"` opens the guided branch, which starts
 * on a "pick 1-3 starter schools" phase — this picks one and confirms past it
 * so callers land on the filter/search/list UI they expect
 * (`e2e/starters.spec.ts` covers that phase itself).
 */
